    ...
    public class Продукты : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПродуктыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПродуктыE", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Продукты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПродуктыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПродуктыL", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Продукты));
                }
            }
        }
    }
