...
namespace IIS.Kursovaya_rabota_Tatarincev_BPC2001
{
    ...
    public class СоставНапитков : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya_rabota_Tatarincev_BPC2001.Единицы fЕдиницы;
        
        private IIS.Kursovaya_rabota_Tatarincev_BPC2001.Продукты fПродукты;
        ...
        public virtual IIS.Kursovaya_rabota_Tatarincev_BPC2001.Единицы Единицы
        {
            get
            {
                ...
                IIS.Kursovaya_rabota_Tatarincev_BPC2001.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Продукты"})]
        [NotNull()]
        public virtual IIS.Kursovaya_rabota_Tatarincev_BPC2001.Продукты Продукты
        {
            get
            {
                ...
                IIS.Kursovaya_rabota_Tatarincev_BPC2001.Продукты result = this.fПродукты;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya_rabota_Tatarincev_BPC2001.Напитки.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставНапитковE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставНапитковE", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.СоставНапитков));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставНапитков : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставНапитков members)

        // *** End programmer edit section *** (IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставНапитков members)
        ...
        /// </summary>
        public DetailArrayOfСоставНапитков(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Напитки fНапитки) : 
                base(typeof(СоставНапитков), ((ICSSoft.STORMNET.DataObject)(fНапитки)))
        {
        }
        
        public IIS.Kursovaya_rabota_Tatarincev_BPC2001.СоставНапитков this[int index]
        {
            get
            {
                return ((IIS.Kursovaya_rabota_Tatarincev_BPC2001.СоставНапитков)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya_rabota_Tatarincev_BPC2001.СоставНапитков dataobject)
        {
