...
namespace IIS.Kursovaya_rabota_Tatarincev_BPC2001
{
    ...
    public class Блюда : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставБлюда fСоставБлюда;
        ...
        public virtual IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставБлюда СоставБлюда
        {
            get
            {
                ...
                {
                    this.fСоставБлюда = new IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставБлюда(this);
                }
                IIS.Kursovaya_rabota_Tatarincev_BPC2001.DetailArrayOfСоставБлюда result = this.fСоставБлюда;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View БлюдаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БлюдаE", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Блюда));
                }
            }
            ...
            public static ICSSoft.STORMNET.View БлюдаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("БлюдаL", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Блюда));
                }
            }
        }
    }
