...
namespace IIS.Kursovaya_rabota_Tatarincev_BPC2001
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya_rabota_Tatarincev_BPC2001.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Kursovaya_rabota_Tatarincev_BPC2001.Должности Должности
        {
            get
            {
                ...
                IIS.Kursovaya_rabota_Tatarincev_BPC2001.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.Kursovaya_rabota_Tatarincev_BPC2001.Сотрудник));
                }
            }
        }
    }
