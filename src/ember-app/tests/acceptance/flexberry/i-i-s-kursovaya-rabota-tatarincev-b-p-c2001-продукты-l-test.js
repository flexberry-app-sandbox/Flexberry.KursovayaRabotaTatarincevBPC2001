...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota tatarincev b p c2001 продукты l');

test('testing i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-продукты-l', function(assert) {
