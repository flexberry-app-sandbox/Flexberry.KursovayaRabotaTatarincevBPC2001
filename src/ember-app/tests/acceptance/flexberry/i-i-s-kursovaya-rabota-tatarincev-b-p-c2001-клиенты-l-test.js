...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota tatarincev b p c2001 клиенты l');

test('testing i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-клиенты-l', function(assert) {
