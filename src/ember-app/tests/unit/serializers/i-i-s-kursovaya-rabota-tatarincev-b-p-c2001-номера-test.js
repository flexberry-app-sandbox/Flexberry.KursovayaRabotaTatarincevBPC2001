...
moduleForModel('i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-номера', 'Unit | Serializer | i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-номера', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-номера',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
