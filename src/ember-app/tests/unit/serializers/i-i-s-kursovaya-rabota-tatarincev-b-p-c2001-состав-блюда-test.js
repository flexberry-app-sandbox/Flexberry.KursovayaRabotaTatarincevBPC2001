...
moduleForModel('i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-состав-блюда', 'Unit | Serializer | i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-состав-блюда', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-состав-блюда',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
