...
moduleForModel('i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-new-class3', 'Unit | Serializer | i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-new-class3', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-tatarincev-b-p-c2001-new-class3',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
